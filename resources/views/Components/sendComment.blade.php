<form action="" method="post" class="flex space-x-2 mt-4">
    <div class="left-txt-area-file-input flex w-[88%] px-2 py-1 rounded-lg border-2 border-gray-100 ">
        <div class="left-txt-area flex flex-col w-full">
            <textarea name="topic" id="topic" cols="1" rows="1" class="w-full h-full border-none outline-none resize-none" placeholder="Type your comment here..."></textarea>
        </div>
    </div>

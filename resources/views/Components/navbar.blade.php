<nav class="flex z-10 shadow-sm flex-row fixed top-0 left-0 right-0 items-center justify-between w-full py-6 px-4  bg-white overflow-hidden">
    ...
    <form action="/" class=" hidden md:block  md:w-[56%]">
        <div class="relative overflow-hidden search-container flex lg:flex-row space-x-1 bg-slate-100 pr-2 rounded-lg" >
            <input type="text" name="search" placeholder="search anything here..." class="h-10 w-full pl-3 pr-5 z-0 focus:shadow focus:outline-none bg-slate-100">
        <button type="submit" class="bg-transparent border-0 outline-none"><i
            class="fa fa-search text-gray-500 z-20 hover:text-gray-500"
        ></i></button>
        </div>

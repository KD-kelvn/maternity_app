    ...
    <div class="page-wrapper w-[96%] md:w-[88%] px-2 py-2 relative">
       ...
       <div class="clients-reviews mt-10">
        ...
        <div class="make-appointment-section mt-10">
            <a href="/users/appointments/" class="bg-transparent  hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
               Make appointment
              </a>
        </div>
    </div>

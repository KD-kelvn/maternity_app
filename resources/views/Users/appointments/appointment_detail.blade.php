...
<x-layout>
  <div class="bg-white rounded-lg shadow-md p-6">
      ...
      <div class="mt-4">
          <p class="text-gray-700 text-sm font-semibold">Amount</p>
          <p class="text-gray-500">{{$appointment->amount}}</p>
      </div>
      <div class="mt-4">
      ...
      <div class="mt-4">
        <p class="text-gray-700 text-sm font-semibold">Doctor Feedback</p>
        <p class="text-green-500">{{$appointment->status}}</p>
      </div>
      <div class="mt-6">
